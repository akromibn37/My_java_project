...
public class LoginFrame extends JFrame {
	...
	public LoginFrame() {
		...
		textField_username.setBounds(124, 45, 209, 23);
		contentPane.add(textField_username);
		textField_username.setColumns(10);
		
		JLabel lblUsername = new JLabel("Username");
		lblUsername.setBounds(33, 51, 63, 14);
		contentPane.add(lblUsername);
		
		JLabel lblPassword = new JLabel("Password");
		lblPassword.setBounds(33, 82, 63, 14);
		...
		btnLogin.setBounds(77, 135, 89, 23);
		...
		btnExit.setBounds(194, 135, 89, 23);
		...
		passwordField.setBounds(124, 79, 209, 23);
