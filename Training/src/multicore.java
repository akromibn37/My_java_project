...
public class multicore
{
	...
	{	
		...
		r4.start();	
		testthread r5 = new testthread(4,"core5",starttime);
		r5.start();	
		testthread r6 = new testthread(5,"core5",starttime);
		r6.start();	
		testthread r7 = new testthread(6,"core5",starttime);
		r7.start();	
		testthread r8 = new testthread(7,"core5",starttime);
		r8.start();	
	}
}
